...
def init_plugin():
    config = {'plugin_name':'MVPAvg',
     'plugin_type':'sim'}
    return (
     config, {})

class MVPAvg(ConflictResolution):
    #The average: All solutions weighted over nconflicts
    def __init__(self):
        super().__init__()
    ...
    def resolve(self, conf, ownship, intruder):
        ...
        dv_mvp_all = (dv_mvp_all.T/conf_count).T #take the average instead of sum
