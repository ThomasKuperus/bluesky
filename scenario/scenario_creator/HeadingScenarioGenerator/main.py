...
minDensity = 25.0  # [ac/10,000 NM^2]
maxDensity = 45.0  # [ac/10,000 NM^2]
numDensities = 3
numRepetitions = 3

# Average TAS of aircraft [kts]
TASavg = 510 #https://www.skybrary.aero/index.php/B744
TASmin = TASavg*0.95
TASmax = TASavg*1.05
...
for hdgDistr in headingDistribution:
    ...
    batchWriter(concepts, numDensities, numRepetitions, scenarioDuration, scenarioFilesDir, hdgDistr,TS)
